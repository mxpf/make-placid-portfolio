...
test("server-renders the portfolio home page", async () => {
  ...
  assert.match(html, /src="\/images\/responsive\/projects\/ibm\/ibm-04-1440\.webp"/);
  assert.match(html, /src="\/images\/responsive\/projects\/nyt\/nyt-01-1440\.webp"/);
  assert.match(html, /src="\/images\/responsive\/projects\/nyt\/nyt-insider-product-1394\.webp"/);
  assert.match(html, /src="\/images\/responsive\/projects\/npr\/npr-ux-1440\.webp"/);
  assert.match(html, /src="\/images\/responsive\/projects\/sands\/sands-details-environment-1440\.webp"/);
